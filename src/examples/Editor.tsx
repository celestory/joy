    ...
    return (
        <Flex height="fill" direction="y">
            ...
            <Flex el="main" grow={true} overflow="auto">
                <Tree lineHeight={1.7} color="theme:subForeground" width="30%" minWidth="20rem" padding="1rem" shrink={false} overflow="auto">
                ...
                <Flex grow={true} align="center" distribute="center">
                    <TextBox color="theme:subForeground" textAlign="center" padding="1rem">
                ...
                <Inspector direction="y" width="20rem" padding="1.5rem" shrink={false} overflow="auto" gap="1.4rem">
                    {components.map(({title, properties}, i) => (
                        <Flex key={i} direction="y" gap="0.8rem">
                            <TextBox weight="bold" color="theme:foreground">
                                {title}
                            </TextBox>
                            {properties.map(({name, value}, i) => (
                                <Flex key={i} align="center">
                                    <TextBox grow={true} color="theme:subForeground" size="0.8rem">
                                        {name}
                                    </TextBox>
